...
Diante do problema proposto e com os dados disponíveis foi possível realizar uma análise e uma modelagem aprofundada para obtenção de um melhor entendimento do problema de negócio e assim a abordagem certa de machine learning fosse adotada. Como resultado final foram entregues a lista de clientes que participariam do grupo de fidelidade Insiders bem como os outros grupos que poderiam ser analisados e a partir de alguma ação poderiam ser convertidos para grupos "acima". Usando modelos como esse para o agrupamento de clientes é possível fazer uma análise e tomar decisões com uma maior conhecimento sobre as características dos clientes e de que forma eles são semelhantes entre si, fazendo com que a tomada de decisão ocorra de uma forma muito mais embasada e ações possam ser tomadas com um risco mais controlado e com uma previsibilidade maior, maximizando as possibilidades de crescimento e retenção de clientes. 

Como possíveis melhorias para o projeto, seria possível fazer um tratamento mais aprofundado em algumas variáveis para a obtenção de informações que poderiam ser úteis na modelagem do problema e na aplicação dos algoritmos de Machine Learning. A obtenção de mais dados também seria outro fator que teria um grande impacto no resultado final e que ajudaria na modelagem do fenômeno e nos resultados do algoritmo.  

Utilizar técnicas de ciencia de dados e inteligência artificial para otimizar a tomada de decisões e fazer com que as empresas cresçam cada vez mais, se torna algo essencial tendo em vista o crescimento da competitividade nos mais diversos setores. Soluções baseadas em dados se motram uma ferramenta muito poderosa e que pode se tornar uma vantagem competitiva se usadas de forma estratégica e inteligente, fazendo com que empresas que não percebem o valor disso consequentemente se tornem obsoletas.
